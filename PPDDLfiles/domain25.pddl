...
(:action moveSync#d#ev4
:precondition (and  (activity d) (tracePointer ev4))
:effect (and (not (tracePointer ev4)) (tracePointer evEND)(probabilistic 1.0 (and (not (activity d)) (activity 1.0))) 
))
...
(:action moveInTheLog#d#ev4-evEND

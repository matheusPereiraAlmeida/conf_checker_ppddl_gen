...
(:action moveSync#c#ev3
:precondition (and  (activity c) (tracePointer ev3))
:effect (and (not (tracePointer ev3)) (tracePointer evEND)(probabilistic 1.0 (and (not (activity c)) (activity 1.0))) 
))
...
(:action moveInTheLog#c#ev3-evEND
:precondition (tracePointer ev3)
:effect (and (not (tracePointer ev3)) (tracePointer evEND) (decrease (reward) 1) ))

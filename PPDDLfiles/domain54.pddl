...
(:action moveSync#d#ev5
:precondition (and  (activity d) (tracePointer ev5))
:effect (and (not (tracePointer ev5)) (tracePointer evEND)(probabilistic 1.0 (and (not (activity d)) (activity 1.0))) 
))
...
(:action moveInTheLog#d#ev5-evEND
:precondition (tracePointer ev5)
:effect (and (not (tracePointer ev5)) (tracePointer evEND) (decrease (reward) 1) ))

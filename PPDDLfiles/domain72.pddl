...
(:action moveSync#d#ev3
:precondition (and  (activity d) (tracePointer ev3))
:effect (and (not (tracePointer ev3)) (tracePointer evEND)(probabilistic 1.0 (and (not (activity d)) (activity 1.0))) 
))
...
(:action moveInTheLog#d#ev3-evEND

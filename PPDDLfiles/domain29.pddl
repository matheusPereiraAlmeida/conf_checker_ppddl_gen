...
(:action moveSync#c#ev5
:precondition (and  (activity c) (tracePointer ev5))
:effect (and (not (tracePointer ev5)) (tracePointer evEND)(probabilistic 1.0 (and (not (activity c)) (activity 1.0))) 
))
...
(:action moveInTheLog#c#ev5-evEND
